...
#define FLAG_AXE_OBTAINED    0x2C // Unused Flag
#define FLAG_LANTERN_OBTAINED    0x2D // Unused Flag
#define FLAG_ROCK_SMASHER_OBTAINED    0x2E // Unused Flag
#define FLAG_BOLDER_PUSHER_OBTAINED    0x2F // Unused Flag
#define FLAG_SURFBOARD_OBTAINED    0x30 // Unused Flag
#define FLAG_BIRD_FLUTE_OBTAINED    0x31 // Unused Flag
#define FLAG_DIVING_EQUIPMENT_OBTAINED    0x32 // Unused Flag
#define FLAG_REVERSE_WATERFALL_OBTAINED    0x33 // Unused Flag
...
#define FLAG_SYS_ALWAYS_ON                           (SYSTEM_FLAGS + 0x3) // Unused Flag
...
#define FLAG_REVERSE_ROLLCALL_FLAG                  (SYSTEM_FLAGS + 0x21) // Unused Flag
#define FLAG_FIONA_REVERSE_ROLLCALL_FLAG            (SYSTEM_FLAGS + 0x22) // Unused Flag
#define FLAG_FIONA_ROOM                             (SYSTEM_FLAGS + 0x23) // Unused Flag
#define FLAG_BATTLE_WON                             (SYSTEM_FLAGS + 0x24) // Unused Flag
#define FLAG_TOURNAMENT_LOST                        (SYSTEM_FLAGS + 0x25) // Unused Flag
#define FLAG_TOURNAMENT                             (SYSTEM_FLAGS + 0x26) // Unused Flag
#define FLAG_REVERSED_GUARD                         (SYSTEM_FLAGS + 0x27) // Unused Flag
...
#define FLAG_GIFT_EVOMASTERS                        (SYSTEM_FLAGS + 0x2E) // Unused Flag
#define FLAG_FREE_MASSAGE                           (SYSTEM_FLAGS + 0x2F) // Unused Flag
...
#define FLAG_TRIED_TO_LOOK                          (SYSTEM_FLAGS + 0x83) // Unused Flag
...
#define FLAG_SIMULATION_ENTERED                     (SYSTEM_FLAGS + 0x89) // Unused Flag
#define FLAG_HIDE_REPLICA_SIMULATION_SISTER         (SYSTEM_FLAGS + 0x8A) // Unused Flag
