...
extern const u8 gText_Kector_Welcome[];
extern const u8 gText_ThisIsAPokemon[];
extern const u8 gText_Kector_LawChange[];
extern const u8 gText_Kector_MainSpeech[];
extern const u8 gText_Kector_Screening[];
extern const u8 gText_Kector_InformationNeeded[];
extern const u8 gText_Kector_AndYouAre[];
extern const u8 gText_Kector_BoyOrGirl[];
extern const u8 gText_Kector_WhatsYourName[];
extern const u8 gText_Kector_SoItsPlayer[];
extern const u8 gText_Kector_YourePlayer[];
extern const u8 gText_Kector_AreYouReady[];
extern const u8 gText_KectorMan[];
extern const u8 gText_KectorWoman[];
