...
void ItemUseOutOfBattle_RockSmasher(u8);
void ItemUseOutOfBattle_BolderPusher(u8);
void ItemUseOutOfBattle_SurfBoard(u8);
void ItemUseOutOfBattle_BirdFlute(u8);
void ItemUseOutOfBattle_DivingEquipment(u8);
void ItemUseOutOfBattle_ReverseWaterfall(u8);
