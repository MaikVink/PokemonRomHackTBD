...
const struct Tileset gTileset_SpecialShop =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SpecialShop,
    .palettes = gTilesetPalettes_SpecialShop,
    .metatiles = gMetatiles_SpecialShop,
    .metatileAttributes = gMetatileAttributes_SpecialShop,
    .callback = NULL,
};
