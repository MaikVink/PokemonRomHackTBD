...
static const struct MenuAction MultichoiceList_Quiz[] =
{
    {gText_ChoiceA},
    {gText_ChoiceB},
    {gText_ChoiceC},
...
static const struct MenuAction MultichoiceList_DojoGrid[]=
{
    {gText_Fiona},
    {gText_Fabian},
    {gText_Herald},
...
static const struct MenuAction MultiChoiceList_USB[] =
{
    {gText_GeneralInfo},
    {gText_EntryLog1358},
    {gText_EntryLog1462},
...
static const struct MenuAction MultiChoiceList_Diary1[] =
{
    {gText_Entry1},
    {gText_Entry2},
    {gText_Entry3},
...
static const struct MenuAction MultiChoiceList_Diary2[] =
{
    {gText_Entry1},
    {gText_Entry2},
    {gText_Entry3},
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_USB]                        = MULTICHOICE(MultiChoiceList_USB),
    [MULTI_DIARY_1]                    = MULTICHOICE(MultiChoiceList_Diary1),
    ...
    [MULTI_DIARY_2]                    = MULTICHOICE(MultiChoiceList_Diary2),
