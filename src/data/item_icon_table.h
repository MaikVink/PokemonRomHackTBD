const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_DRILL] = {gItemIcon_Drill, gItemIconPalette_Drill},
    [ITEM_MECHANICAL_ARM] = {gItemIcon_MechanicalArm, gItemIconPalette_MechanicalArm},
    ...
    [ITEM_AQUA_JETPACK] = {gItemIcon_AquaJetpack, gItemIconPalette_AquaJetpack},
