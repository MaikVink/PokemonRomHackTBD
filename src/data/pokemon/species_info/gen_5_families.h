...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_SAMUROTT},
                                {EVO_ITEM, ITEM_DUBIOUS_DISC, SPECIES_SAMUROTT_HISUI}),
    },
    ...
    [SPECIES_KARRABLAST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_ESCAVALIER, CONDITIONS({IF_SPECIES_IN_PARTY, SPECIES_SHELMET})},
    ...
    [SPECIES_SHELMET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_ACCELGOR, CONDITIONS({IF_SPECIES_IN_PARTY, SPECIES_KARRABLAST})},
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 54, SPECIES_BRAVIARY},
                                {EVO_ITEM, ITEM_PRISM_SCALE, SPECIES_BRAVIARY_HISUI}),
    },
