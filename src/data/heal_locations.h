static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PLAYERROOM - 1] = {MAP_GROUP(MODHEADQUARTERS_PLAYER_ROOM), MAP_NUM(MODHEADQUARTERS_PLAYER_ROOM), 5, 5},
    [HEAL_LOCATION_FIONASROOM - 1] = {MAP_GROUP(MODHEADQUARTERS_FIONAS_ROOM), MAP_NUM(MODHEADQUARTERS_FIONAS_ROOM), 5, 5},
    [HEAL_LOCATION_CLIFF_TO_NOWHERE - 1] = {MAP_GROUP(CLIFF_TO_NOWHERE), MAP_NUM(CLIFF_TO_NOWHERE), 16, 16},
};
